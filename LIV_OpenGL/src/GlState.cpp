...
#undef CASE
            ...
            default:
                if(entry.second.type == GlState::GlStateVariable::INT){
                    for(uint32_t i = 0; i < entry.second.size; ++i)
                        sstr << ((i > 0) ? ", " : "") << entry.second.vali[i];
                }else if(entry.second.type == GlState::GlStateVariable::FLOAT){
                    for(uint32_t i = 0; i < entry.second.size; ++i)
                        sstr << ((i > 0) ? ", " : "") << entry.second.valf[i];
    ...
    GlState GlState::queryAll(){
        ...
        state.initGlParameter<int>(GL_TEXTURE_CUBE_MAP_SEAMLESS, 1);
    ...
    GlState::GlStateVariable::GlStateVariable(int32_t i1, int32_t i2, int32_t i3): type(INT), vali{i1, i2, i3, 0}, size(3){}
    GlState::GlStateVariable::GlStateVariable(int32_t i1, int32_t i2, int32_t i3, int32_t i4): type(INT), vali{i1, i2, i3, i4}, size(4){}
    ...
    GlState::GlStateVariable::GlStateVariable(float f1, float f2, float f3, float f4):type(FLOAT), valf{f1, f2, f3, f4}, size(4){}
    ...
    bool GlState::GlStateVariable::operator!=(const LIV_OpenGL::GlState::GlStateVariable &other) const {
        return !(*this == other);
    }
    ...
    void GlState::difference(const LIV_OpenGL::GlState &other) const {
