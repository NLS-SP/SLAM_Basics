...
class PNPAnalyticOptmized : public ceres::SizedCostFunction<2, 6>{
...
int main(int argc, char **argv)
{
    ...
    cout << "Solve PNP by gauss newton cost time: " << time_used.count() << std::endl;
...
void bundleAdjustmentGaussNewton(
    ...
    std::cout << "Pose by Gauss-newton is: " << pose.matrix() << std::endl;
}
